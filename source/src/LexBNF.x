...
resWords =
  b "digit" 20
    ...
    (b "separator" 30
       (b "letter" 25
          (b "internal" 23
             (b "eps" 22 (b "entrypoints" 21 N N) N) (b "layout" 24 N N))
          (b "position" 28
             (b "nonempty" 27 (b "lower" 26 N N) N) (b "rules" 29 N N)))
       (b "upper" 35
          (b "token" 33
             (b "terminator" 32 (b "stop" 31 N N) N) (b "toplevel" 34 N N))
          (b "|" 38 (b "{" 37 (b "views" 36 N N) N) (b "}" 39 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
