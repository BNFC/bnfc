...
cf2alex2 :: String -> String -> String -> Bool -> TokenText -> CF -> String
cf2alex2 name errMod shareMod shareStrings tokenText cf =
  unlines $ intercalate [""] [
    prelude name errMod shareMod shareStrings tokenText,
    cMacros,
    rMacros cf,
    restOfAlex shareMod shareStrings tokenText cf
   ]

prelude :: String -> String -> String -> Bool -> TokenText -> [String]
prelude name _ shareMod shareStrings tokenText = concat
  [ [ "-- -*- haskell -*-"
