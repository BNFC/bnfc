...
cf2Happy name absName lexName errName mode tokenText functor cf = unlines
  [ header name absName lexName errName tokenText
...
header :: String -> String -> String -> String -> TokenText -> String
header modName absName lexName errName tokenText = unlines $ concat
