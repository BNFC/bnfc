...
cf2Abstract
  ...
  -> CF       -- ^ Grammar
  -> Doc
cf2Abstract byteStrings ghcExtensions functor name cf = vcat . concat $
    [ [ "-- Haskell data types for the abstract syntax."
      , "-- Generated by the BNF converter."
      , ""
      ]
    , [ "{-# LANGUAGE DeriveDataTypeable #-}" | ghcExtensions ]
    , [ "{-# LANGUAGE DeriveGeneric #-}"      | ghcExtensions ]
    , [ ""                                    | ghcExtensions ]
...
-- <BLANKLINE>
--
-- Note that the layout adapts if it does not fit in a line:
