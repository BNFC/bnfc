...
cf2Layout tokenText layName lexName cf = unlines $ concat
  ...
  , [ "import Data.Maybe (isNothing, fromJust)"
    ...
    , "type Position = Posn"
    , ""
    , "-- | Insert a number of tokens at the beginning of a list of tokens."
    ...
    , ""
    , "-- | Insert a new symbol token at the beginning of a list of tokens."
    , "addToken :: Position -- ^ Position of the new token."
    , "         -> String   -- ^ Symbol in the new token."
    , "         -> [Token]  -- ^ The rest of the tokens."
    , "         -> [Token]"
    , "addToken p s ts = sToken p s : ts"
    , ""
