...
cf2Layout tokenText layName lexName cf = unlines $ concat
  ...
  , [ ""
    ...
    , "                       moveAlong st' [sToken (afterPrev pt) layoutSep, t0, b] ts"
    ...
    , "                 else moveAlong st' (t0 : map (const t0) imps) ts"
    , ""
    ...
    , "          else moveAlong st [sToken (afterPrev pt) layoutSep, t0] ts"
    , ""
    ...
    , "      moveAlong bs [sToken (nextPos t) layoutClose] []"
    , ""
