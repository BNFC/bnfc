...
makeC opts cf = do
  ...
  where prefix :: String  -- The prefix is a string used by flex and bison
                          ...
                          -- In most cases we want the grammar name as the 
                          -- prefix but in a few specific cases, this can 
                          -- create clashes with existing functions
...
ctest cf =
  unlines
   [
    "/*** Compiler Front-End Test automatically generated by " ++
      "the BNF Converter ***/",
    "/*                                                      " ++
      "                    */",
    "/* This test will parse a file, print the abstract syntax " ++
      "tree, and then    */",
...
mkHeaderFile cf cats eps env = unlines
 ...
 where
  ...
  mkFunc s | normCat s == s = identCat s ++ " p" ++ identCat s ++ 
    "(FILE *inp);\n"
  mkFunc _ = ""
